...
Categorie[] listeCategorie=connexion.getCategorie();
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td> 
                                                <% out.print(listeCategorie[i].getNomCategorie()); %>
                                                </td>
                                                <td> 
                                                    <a href="ModificationCategorie.jsp?idcat=<% out.print(listeCategorie[i].getIdCategorie()); %>&&nomcat=<% out.print(listeCategorie[i].getNomCategorie());%>" type="button" >Modifier</a>
                                                    <a href="SupprimerCategorie.jsp?idcat=<% out.print(listeCategorie[i].getIdCategorie()); %> " type="button" type="button">Supprimer</a>
                                               </td>
                                            </tr>
                                            <% } %>
                                        </tbody>
