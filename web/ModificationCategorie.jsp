...
String nomcategorie=request.getParameter("nomcat");
    ...
    <div id="wrapper">
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                     ...
                     <li>
                      ...
                      <li>
                        <a href="ListeCategorie.jsp"><i class="fa fa-list-alt fa-2x"></i> Liste des Categories</a>
                    </li>
                    <li>
		...
		<div id="row">
                    <div class="col-lg-12">
                         <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Modification Categorie:</h3>
                            </div>
                        <div class="panel-body">
                       
                        <form role="form" method="get" action="modifcat.jsp">
                            <div class="form-group">
                                <label>Nom Categorie:</label>
                                <input class="form-control" placeholder="" name="nom" value="<% out.print(nomcategorie);%>">
                                <br>
                                 <input type="hidden"  name="idcat" value="<% out.print(id); %>">
